...
(defcustom vlog-company "Verilab GmbH"
  "Default name of Company for (System)Verilog headers. If set will become buffer local."
  :group 'verilog-mode
  :type 'string
)
;;;;
...
(defun verilog-insert-file-body()
  ...
  (insert-file (concat verilog-template-dir "templates/verilog_body.tmpl"))
    ...
    (search-forward "<company>") (replace-match vlog-company t t)
    (goto-char start)
    (let (string)
